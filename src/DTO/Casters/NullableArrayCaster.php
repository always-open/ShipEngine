...
class NullableArrayCaster implements Caster
{
    ...
    private function castItem(mixed $data)
    {
        ...
        throw new LogicException(
            "Caster [NullableArrayCaster] each item must be an array, null, or an instance of the specified item type [{$this->itemType}]."
        );
    }
}
